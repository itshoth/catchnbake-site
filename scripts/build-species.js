...
const SPECIES = [
  {
    ...
    clean: {
      ...
      steps: [
        ...
        "Run the blade along the spine over the rib cage rather than through it, because the ribs are thick enough to stop a knife. Lift the fillet as you go.",
  ...
  },
  {
    ...
    methods: {
      ...
      items: [
        { name: 'Grilled with citrus', body: "Thick snook fillets hold a grill grate with confidence. Oil well, season simply with salt, pepper, and a little paprika, and grill over medium-high heat 4–5 minutes a side, finishing with lime butter. The sweetness needs nothing more." },
  ...
  },
  {
    ...
    taste: {
      ...
      body: [
        "Mild, subtly sweet, and clean, with no strong or oily notes at all. The fillets are thick and snow-white with a big, moist flake that holds together whether you fry, grill, or blacken it. It's the texture that makes grouper famous: closer to lobster-tender chunks than to a thin, delicate fillet.",
    ...
    clean: {
      ...
      body: [
        "Groupers clean generously, with big fillets, forgiving structure, and two things to know: tough skin, and a bonus cut most people throw away."
      ],
      steps: [
    ...
    faq: [
      ...
      { q: 'What does gag grouper taste like?', a: "Mild and subtly sweet with thick, snow-white fillets and a big moist flake, with no oily or fishy notes. The texture is the signature: firm enough for sandwiches, grilling, and blackening without falling apart." },
      { q: 'When can you keep gag grouper in Florida?', a: "Only during open season, and the seasons differ between Florida state waters and Gulf federal waters, and they've also changed significantly in recent years, with some short Gulf seasons. Always check the current FWC recreational grouper regulations for your specific waters before keeping a gag." },
  ...
  },
  {
    ...
    clean: {
      ...
      steps: [
        ...
        "Run the blade along the backbone and over the rib cage, lifting as you go, the same cut as a redfish.",
  ...
  },
  {
    ...
    clean: {
      ...
      steps: [
        ...
        "Cook or smoke within a day or two. Spanish mackerel is a poor freezer, so plan the menu, not the stockpile."
      ]
    },
    methods: {
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Do you eat grouper skin?', a: "No: grouper skin is thick, tough, and strong-tasting, so fillets are always skinned before cooking. The cheeks and throats, though, are some of the best meat on the fish, so don't waste them." }
    ],
...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .guide-row{display:grid;grid-template-columns:9rem minmax(0,1fr) auto;align-items:baseline;gap:1.5rem;padding:1.15rem 0;border-bottom:1px solid var(--line);text-decoration:none;color:var(--bone)}
  ...
  .guide-row p{margin:0}
  @media (max-width:700px){
    .guide-row{display:flex;flex-direction:column;align-items:flex-start;gap:.65rem}
    .guide-row h3{font-size:1.4rem}
    .guide-row p{width:100%;max-width:none;font-size:1rem;line-height:1.6}
    .guide-row .go{white-space:normal}
  }
